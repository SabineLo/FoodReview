<!--Try and organize the comment section differently perchance different rows or put most recent comment on top-->
<?php 
...
<body>
    ...
    <!--the tab section with menus-->            
            ...
            echo"<form method='POST' action='".setComments1($conn)."'>
                <input type='hidden' name='uid1' value='Anonymous'>
