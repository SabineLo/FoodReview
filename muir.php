...
<header>
    ...
    <div class="container">
    	<div class="card">
    		<div class="card-header">FoodReview</div>
    		<div class="card-body">
    			<div class="row">
    	...
    	<div class="modal-content">
	      	...
	      	<div class="modal-body">
	        	...
	        	<div class="form-group">
	        		<input type="text" name="user_name1" id="user_name1" class="form-control" placeholder="Enter Your Name" />
	        	</div>
	        	<div class="form-group">
	        		<textarea name="user_review1" id="user_review1" class="form-control" placeholder="Type Review Here"></textarea>
	        	</div>
